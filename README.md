...
ssh host 'nohup /tmp/remorkd --root /path/to/workspace --addr 0.0.0.0:17731 >/tmp/remorkd.log 2>&1 &'
```
...
```bash
base_hash="sha256:$(shasum -a 256 local-or-remote-base-file | awk '{print $1}')"
```
